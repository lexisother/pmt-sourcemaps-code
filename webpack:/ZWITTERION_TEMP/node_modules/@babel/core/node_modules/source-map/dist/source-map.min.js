  ...
  return function (e) {
    ...
    t.fromSourceMap = function (e) {
      ...
      for (var r, t, o, s, u, l = 1, p = 0, h = 0, f = 0, d = 0, m = 0, _ = e.length, v = 0, y = {}, C = {}, A = [], S = []; v < _;) if (";" === e.charAt(v)) l++, v++, p = 0;else if ("," === e.charAt(v)) v++;else {
        for (r = new i(), r.generatedLine = l, s = v; s < _ && !this._charIsMappingSeparator(e, s); s++);
        if (t = e.slice(v, s), o = y[t]) v += t.length;else {
          for (o = []; v < s;) c.decode(e, v, C), u = C.value, v = C.rest, o.push(u);
    ...
    function o(e, n, i, s) {
      if (i < s) {
        var a = t(i, s),
          u = i - 1;
        r(e, a, s);
        for (var l = e[s], c = i; c < s; c++) n(e[c], l) <= 0 && (u += 1, r(e, u, c));
        r(e, u + 1, c);
        var g = u + 1;
    ...
    t.fromStringWithSourceMap = function (e, n, r) {
      ...
      for (var n, r = 0, t = this.children.length; r < t; r++) n = this.children[r], n[u] ? n.walk(e) : "" !== n && e(n, {
        source: this.source,
        line: this.line,
        column: this.column,
        name: this.name
      ...
      for (var n = 0, r = this.children.length; n < r; n++) this.children[n][u] && this.children[n].walkSourceContents(e);
      for (var t = Object.keys(this.sourceContents), n = 0, r = t.length; n < r; n++) e(i.fromSetString(t[n]), this.sourceContents[t[n]]);
    }, t.prototype.toString = function () {
      var e = "";
      ...
      return this.walk(function (e, o) {
        ...
        for (var c = 0, g = e.length; c < g; c++) e.charCodeAt(c) === a ? (n.line++, n.column = 0, c + 1 === g ? (i = null, t = !1) : t && r.addMapping({
          source: o.source,
          original: {
            line: o.line,
            column: o.column
