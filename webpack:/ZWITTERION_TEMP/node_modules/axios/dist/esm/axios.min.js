...
function w(e, t, {
  ...
  if (null == e) return;
  let r, o;
  if ("object" != typeof e && (e = [e]), a(e)) for (r = 0, o = e.length; r < o; r++) t.call(null, e[r], r, e);else {
  ...
  x = {
    ...
    merge: function e() {
      const {
        ...
        r = (r, o) => {
          const s = t && O(n, o) || o;
          p(n[s]) && p(r) ? n[s] = e(n[s], r) : p(r) ? n[s] = e({}, r) : a(r) ? n[s] = r.slice() : n[s] = r;
        };
      for (let e = 0, t = arguments.length; e < t; e++) arguments[e] && w(arguments[e], r);
      return n;
    },
    extend: (t, n, r, {
      allOwnKeys: o
    ...
    freezeMethods: e => {
      v(e, (t, n) => {
        if (f(e) && -1 !== ["arguments", "caller", "callee"].indexOf(n)) return !1;
        const r = e[n];
...
}), Object.defineProperties(P, _), Object.defineProperty(U, "isAxiosError", {
  value: !0
}), P.from = (e, t, n, r, o, s) => {
  const i = Object.create(U);
  return x.toFlatObject(e, i, function (e) {
    return e !== Error.prototype;
  }, e => "isAxiosError" !== e), P.call(i, e.message, t, n, r, o), i.cause = e, i.name = e.name, s && Object.assign(i, s), i;
};
...
function q(e, t, n) {
  ...
  const r = (n = x.toFlatObject(n, {
    ...
    s = n.dots,
    i = n.indexes,
    a = (n.Blob || "undefined" != typeof Blob && Blob) && (c = t) && x.isFunction(c.append) && "FormData" === c[Symbol.toStringTag] && c[Symbol.iterator];
  var c;
  if (!x.isFunction(o)) throw new TypeError("visitor must be a function");
  function u(e) {
    if (null === e) return "";
    if (x.isDate(e)) return e.toISOString();
    if (!a && x.isBlob(e)) throw new P("Blob is not supported. Use a Buffer instead.");
    return x.isArrayBuffer(e) || x.isTypedArray(e) ? a && "function" == typeof Blob ? new Blob([e]) : Buffer.from(e) : e;
  }
  function l(e, n, o) {
    let a = e;
    if (e && !o && "object" == typeof e) if (x.endsWith(n, "{}")) n = r ? n : n.slice(0, -2), e = JSON.stringify(e);else if (x.isArray(e) && function (e) {
      return x.isArray(e) && !e.some(B);
    }(e) || x.isFileList(e) || x.endsWith(n, "[]") && (a = x.toArray(e))) return n = D(n), a.forEach(function (e, r) {
      !x.isUndefined(e) && null !== e && t.append(!0 === i ? L([n], r, s) : null === i ? n : n + "[]", u(e));
    }), !1;
  ...
  return function e(n, r) {
    if (!x.isUndefined(n)) {
      ...
      f.push(n), x.forEach(n, function (n, s) {
        !0 === (!(x.isUndefined(n) || null === n) && o.call(t, n, x.isString(s) ? s.trim() : s, r, d)) && e(n, r ? r.concat(s) : [s]);
      }), f.pop();
    }
  }(e), t;
}
...
function H(e, t, n) {
  ...
  const r = n && n.encode || J,
    o = n && n.serialize;
  let s;
  if (s = o ? o(t, n) : x.isURLSearchParams(t) ? t.toString() : new I(t, n).toString(r), s) {
    const t = e.indexOf("#");
...
const V = class {
  ...
  X = "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope && "function" == typeof self.importScripts,
  Q = {
    isBrowser: !0,
    classes: {
      URLSearchParams: K,
...
function Z(e) {
  function t(e, n, r, o) {
    ...
    const i = Number.isFinite(+s),
      a = o >= e.length;
    if (s = !s && x.isArray(r) ? r.length : s, a) return x.hasOwnProp(r, s) ? r[s] = [r[s], n] : r[s] = n, !i;
    r[s] && x.isObject(r[s]) || (r[s] = []);
    return t(e, n, r[s], o) && x.isArray(r[s]) && (r[s] = function (e) {
      const t = {},
        n = Object.keys(e);
      let r;
      const o = n.length;
  ...
  transformRequest: [function (e, t) {
    ...
    if (o) {
      if (n.indexOf("application/x-www-form-urlencoded") > -1) return function (e, t) {
        return q(e, new Q.classes.URLSearchParams(), Object.assign({
...
const te = ee,
  ne = x.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
  re = Symbol("internals");
function oe(e) {
...
function ie(e, t, n, r) {
  return x.isFunction(r) ? r.call(this, t, n) : x.isString(t) ? x.isString(r) ? -1 !== t.indexOf(r) : x.isRegExp(r) ? r.test(t) : void 0 : void 0;
}
class ae {
  constructor(e) {
    e && this.set(e);
  ...
  set(e, t, n) {
    ...
    function o(e, t, n) {
      ...
      (!s || void 0 === r[s] || !0 === n || void 0 === n && !1 !== r[s]) && (r[s || t] = se(e));
    }
    const s = (e, t) => x.forEach(e, (e, n) => o(e, n, t));
    return x.isPlainObject(e) || e instanceof this.constructor ? s(e, t) : x.isString(e) && (e = e.trim()) && !/^[-_a-zA-Z]+$/.test(e.trim()) ? s((e => {
      const t = {};
      let n, r, o;
      return e && e.split("\n").forEach(function (e) {
        o = e.indexOf(":"), n = e.substring(0, o).trim().toLowerCase(), r = e.substring(o + 1).trim(), !n || t[n] && ne[n] || ("set-cookie" === n ? t[n] ? t[n].push(r) : t[n] = [r] : t[n] = t[n] ? t[n] + ", " + r : r);
      }), t;
...
ae.accessor(["Content-Type", "Content-Length", "Accept", "Accept-Encoding", "User-Agent"]), x.freezeMethods(ae.prototype), x.freezeMethods(ae);
const ce = ae;
function ue(e, t) {
  const n = this || te,
    r = t || n,
...
const de = Q.isStandardBrowserEnv ? {
  write: function (e, t, n, r, o, s) {
    const i = [];
    i.push(e + "=" + encodeURIComponent(t)), x.isNumber(n) && i.push("expires=" + new Date(n).toGMTString()), x.isString(r) && i.push("path=" + r), x.isString(o) && i.push("domain=" + o), !0 === s && i.push("secure"), document.cookie = i.join("; ");
  },
  read: function (e) {
...
const pe = Q.isStandardBrowserEnv ? function () {
...
const ye = {
  ...
  xhr: "undefined" != typeof XMLHttpRequest && function (e) {
    return new Promise(function (t, n) {
      ...
      x.isFormData(r) && (Q.isStandardBrowserEnv || Q.isStandardBrowserWebWorkerEnv) && o.setContentType(!1);
      ...
      function l() {
        if (!c) return;
        const r = ce.from("getAllResponseHeaders" in c && c.getAllResponseHeaders());
        !function (e, t, n) {
      ...
      if (c.open(e.method.toUpperCase(), H(u, e.params, e.paramsSerializer), !0), c.timeout = e.timeout, "onloadend" in c ? c.onloadend = l : c.onreadystatechange = function () {
        c && 4 === c.readyState && (0 !== c.status || c.responseURL && 0 === c.responseURL.indexOf("file:")) && setTimeout(l);
      }, c.onabort = function () {
        c && (n(new P("Request aborted", P.ECONNABORTED, e, c)), c = null);
      }, c.onerror = function () {
        n(new P("Network Error", P.ERR_NETWORK, e, c)), c = null;
      }, c.ontimeout = function () {
        let t = e.timeout ? "timeout of " + e.timeout + "ms exceeded" : "timeout exceeded";
        const r = e.transitional || W;
        e.timeoutErrorMessage && (t = e.timeoutErrorMessage), n(new P(t, r.clarifyTimeoutError ? P.ETIMEDOUT : P.ECONNABORTED, e, c)), c = null;
      }, Q.isStandardBrowserEnv) {
        const t = (e.withCredentials || pe(u)) && e.xsrfCookieName && de.read(e.xsrfCookieName);
        t && o.set(e.xsrfHeaderName, t);
      }
      void 0 === r && o.setContentType(null), "setRequestHeader" in c && x.forEach(o.toJSON(), function (e, t) {
        c.setRequestHeader(t, e);
      }), x.isUndefined(e.withCredentials) || (c.withCredentials = !!e.withCredentials), s && "json" !== s && (c.responseType = e.responseType), "function" == typeof e.onDownloadProgress && c.addEventListener("progress", me(e.onDownloadProgress, !0)), "function" == typeof e.onUploadProgress && c.upload && c.upload.addEventListener("progress", me(e.onUploadProgress)), (e.cancelToken || e.signal) && (i = t => {
        c && (n(!t || t.type ? new fe(null, e, c) : t), c.abort(), c = null);
      }, e.cancelToken && e.cancelToken.subscribe(i), e.signal && (e.signal.aborted ? i() : e.signal.addEventListener("abort", i)));
      const f = function (e) {
        const t = /^([-+\w]{1,25})(:?\/\/|:)/.exec(e);
        return t && t[1] || "";
      }(u);
      f && -1 === Q.protocols.indexOf(f) ? n(new P("Unsupported protocol " + f + ":", P.ERR_BAD_REQUEST, e)) : c.send(r || null);
    });
  }
};
x.forEach(ye, (e, t) => {
...
const ge = e => {
  ...
  let n, r;
  for (let o = 0; o < t && (n = e[o], !(r = x.isString(n) ? ye[n.toLowerCase()] : n)); o++);
  if (!r) {
    if (!1 === r) throw new P(`Adapter ${n} is not supported by the environment`, "ERR_NOT_SUPPORT");
    throw new Error(x.hasOwnProp(ye, n) ? `Adapter '${n}' is not available in the build` : `Unknown adapter '${n}'`);
  }
...
function Ee(e) {
  be(e), e.headers = ce.from(e.headers), e.data = ue.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1);
  return ge(e.adapter || te.adapter)(e).then(function (t) {
    return be(e), t.data = ue.call(e, e.transformResponse, t), t.headers = ce.from(t.headers), t;
  }, function (t) {
    return le(t) || (be(e), t && t.response && (t.response.data = ue.call(e, e.transformResponse, t.response), t.response.headers = ce.from(t.response.headers))), Promise.reject(t);
  });
}
...
function Oe(e, t) {
  ...
  return x.forEach(Object.keys(e).concat(Object.keys(t)), function (r) {
    const s = c[r] || o,
      i = s(e[r], t[r], r);
...
Se.transitional = function (e, t, n) {
  function r(e, t) {
    return "[Axios v1.2.5] Transitional option '" + e + "'" + t + (n ? ". " + n : "");
  }
  return (n, o, s) => {
    if (!1 === e) throw new P(r(o, " has been removed" + (t ? " in " + t : "")), P.ERR_DEPRECATED);
    return t && !Re[o] && (Re[o] = !0, console.warn(r(o, " has been deprecated since v" + t + " and will be removed in the near future"))), !e || e(n, o, s);
  };
};
const Ae = {
...
class Ne {
  ...
  request(e, t) {
    "string" == typeof e ? (t = t || {}).url = e : t = e || {}, t = Oe(this.defaults, t);
    const {
      transitional: n,
      paramsSerializer: r,
      headers: o
    ...
    }, !1), void 0 !== r && Ae.assertOptions(r, {
      encode: Te.function,
      serialize: Te.function
    }, !0), t.method = (t.method || this.defaults.method || "get").toLowerCase(), s = o && x.merge(o.common, o[t.method]), s && x.forEach(["delete", "get", "head", "post", "put", "patch", "common"], e => {
      delete o[e];
  ...
  getUri(e) {
    return H(he((e = Oe(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer);
  }
}
...
const Ue = function t(n) {
  ...
  return x.extend(o, je.prototype, r, {
    allOwnKeys: !0
  }), x.extend(o, r, null, {
    allOwnKeys: !0
  }), o.create = function (e) {
...
Ue.Axios = je, Ue.CanceledError = fe, Ue.CancelToken = ve, Ue.isCancel = le, Ue.VERSION = "1.2.5", Ue.toFormData = q, Ue.AxiosError = P, Ue.Cancel = Ue.CanceledError, Ue.all = function (e) {
...
}, Ue.mergeConfig = Oe, Ue.AxiosHeaders = ce, Ue.formToJSON = e => Z(x.isHTMLForm(e) ? new FormData(e) : e), Ue.HttpStatusCode = Pe, Ue.default = Ue;
const _e = Ue,
  {
    Axios: Fe,
    AxiosError: Be,
...
export { Fe as Axios, Be as AxiosError, Ve as AxiosHeaders, Ie as Cancel, ke as CancelToken, De as CanceledError, We as HttpStatusCode, qe as VERSION, Me as all, _e as default, Ke as formToJSON, ze as isAxiosError, Le as isCancel, $e as mergeConfig, Je as spread, He as toFormData };
