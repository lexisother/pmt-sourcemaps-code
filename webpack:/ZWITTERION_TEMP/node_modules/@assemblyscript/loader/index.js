...
export function instantiate(source, imports = {}) {
  return __awaiter(this, void 0, void 0, function* () {
    if (isResponse(source = yield source)) return instantiateStreaming(source, imports);
    const module = isModule(source) ? source : yield WebAssembly.compile(source);
...
export function instantiateStreaming(source, imports = {}) {
  return __awaiter(this, void 0, void 0, function* () {
    if (!WebAssembly.instantiateStreaming) {
      return instantiate(isResponse(source = yield source) ? source.arrayBuffer() : source, imports);
    }
    const extended = preInstantiate(imports);
    const result = yield WebAssembly.instantiateStreaming(source, imports);
