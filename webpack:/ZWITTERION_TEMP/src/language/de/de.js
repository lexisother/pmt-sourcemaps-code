...
/** CONFIGURATION PAGES */
import contextRoutes from '../../language/de/pages/configuration/contextRoutes'
import cao from '../../language/de/pages/configuration/cao'
import manageAccounts from '../../language/en/pages/configuration/manageAccounts'
import departments from '../../language/de/pages/configuration/departments'
import departmentMapping from '../../language/de/pages/configuration/departmentMapping'
import subDepartments from '../../language/en/pages/configuration/subDepartments'
import storeGroups from '../../language/de/pages/configuration/storeGroups'
import publicHolidays from '../../language/de/pages/configuration/publicHolidays'
import holidayRules from '../../language/de/pages/configuration/holidayRules'
import schoolHolidays from '../../language/de/pages/configuration/schoolHolidays'
import standardTimes from '../../language/de/pages/configuration/standardTimes'

import barButton from './top-bars/barButton'

import common from './entities/common'
import filtersFlyOut from '../de/ui/filtersFlyOut'
