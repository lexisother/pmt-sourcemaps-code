...
/** CONFIGURATION PAGES */
import contextRoutes from '../../language/nl/pages/configuration/contextRoutes'
import cao from '../../language/nl/pages/configuration/cao'
import manageAccounts from '../../language/nl/pages/configuration/manageAccounts'
import departments from '../../language/nl/pages/configuration/departments'
import departmentMapping from '../../language/nl/pages/configuration/departmentMapping'
import subDepartments from '../../language/nl/pages/configuration/subDepartments'
import storeGroups from '../../language/nl/pages/configuration/storeGroups'
import publicHolidays from '../../language/nl/pages/configuration/publicHolidays'
import holidayRules from '../../language/nl/pages/configuration/holidayRules'
import schoolHolidays from '../../language/nl/pages/configuration/schoolHolidays'
import standardTimes from '../../language/nl/pages/configuration/standardTimes'
